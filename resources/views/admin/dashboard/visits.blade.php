                ...
                <div class="card">
                    <div class="card-header  text-bg-secondary  text-bg-secondary d-flex justify-content-between align-items-center">
                        ...
                        <ul class="list-unstyled mb-0 filter-range-list">
                            ...
                            <li class="d-inline-block"><a class="text-sm nav-link" href="?date_filter=today">Today</a>
                            </li>
                            <li class="d-inline-block"><a class="text-sm nav-link" href="?date_filter=week">Week</a>
                            </li>
                            <li class="d-inline-block"><a class="text-sm nav-link" href="?date_filter=month">Month</a>
                            </li>
                            <li class="d-inline-block"><a class="text-sm nav-link" href="?date_filter=year">Year</a>
                            </li>
                        </ul>
                    </div>
                    <div class="card-body">
...
{{--                        <canvas id="month-visits-line"></canvas>--}}
                    ...
                    <div class="tab-pane fade" id="year-visits-tab-pane" role="tabpanel"
                        ...
                        <div id="year-visits-line" style="  max-width: 90%;
...
@section('scripts')
    ...
    <script>
        ...
        var paletteScale = d3.scale.linear()
            ...
            .range(["#a9f399", "#0b3a01"]); // blue color
    ...
    <script>
        ...
        var yearVisitsCanvas = {
            ...
            xaxis: {
                categories: [...Object.keys({!! $yearVisitsArr !!})]
            }
        }

        var chart = new ApexCharts(document.querySelector("#year-visits-line"), yearVisitsCanvas);

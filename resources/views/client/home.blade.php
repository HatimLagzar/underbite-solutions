  ...
  <section id="form-wrapper">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 col-12 apply-col" style="margin-top: -350px;">
    ...
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-12 col-md-6">
          <p class="quote text-center text-md-start">
            ...
            "</p>
          <p class="text-muted author text-center text-md-start">Mikael Makarov</p>
        </div>
      </div>
    </div>
  </section>

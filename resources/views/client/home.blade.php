                    ...
                    <div id="apply-now" class="apply-wrapper">
                        <form method="POST" action="#">
                            ...
                            <div class="row">
                                <div class="form-group col-12 col-lg-6 mb-3">
                                    <label class="form-label" for="firstNameInput">{{__('First Name')}} <small
                                            class="text-muted"
                                ...
                                <div class="form-group col-12 col-lg-6 mb-3">
                                    <label class="form-label" for="lastNameInput">{{__('Last Name')}} <small
                                            class="text-muted"
                                            style="font-size: 12px;">({{__('Required')}}
                                            )</small></label>
                            ...
                            <div class="row">
                                <div class="form-group col-12 col-lg-6 mb-3">
                                    <label class="form-label" for="genderInput">{{__('Your Gender')}} <small
                                            class="text-muted"
                                            style="font-size: 12px;">({{__('Required')}}
                                            )</small></label>
                                ...
                                <div class="form-group col-12 col-lg-6 mb-3">
                                    <label class="form-label" for="ageInput">{{__('Your Age')}} <small
                                            class="text-muted"
                                            style="font-size: 12px;">({{__('Required')}}
                                            )</small></label>
                                    <select
                            ...
                            <div class="row">
                                <div class="form-group col-12 col-lg-6 mb-3">
                                    <label class="form-label" for="heightInput">{{__('Your Height')}} <small
                                            class="text-muted"
                                            style="font-size: 12px;">({{__('Required')}}
                                            )</small></label>
                                    <select
                                ...
                                <div class="form-group col-12 col-lg-6 mb-3">
                                    <label class="form-label" for="weightInput">{{__('Your Weight')}} <small
                                            class="text-muted"
                                            style="font-size: 12px;">({{__('Required')}}
                                            )</small></label>
                                    <select
                            ...
                            <div class="row">
                                <div class="form-group col-12 col-lg-6 mb-3">
                                    <label class="form-label" for="emailInput">{{__('Your Email')}} <small
                                            class="text-muted"
                                            style="font-size: 12px;">({{__('Required')}}
                                            )</small></label>
                                ...
                                <div class="form-group col-12 col-lg-6 mb-3">
                                    <label class="form-label" for="countryInput">{{__('Your Origin/Country')}} <small
                                            class="text-muted"
                            ...
                            <div class="row">
                                <div class="form-group col-12 col-lg-6 mb-3">
                                    <label class="form-label" for="phoneInput">{{__('Phone Number')}} <small
                                            class="text-muted"
                                            style="font-size: 12px;">({{__('Required')}})</small></label>
                                ...
                                <div class="form-group col-12 col-lg-6 mb-3">
                                    ...
                                    >
                                        ...
                                        <option
                                            value="SEARCH_ENGINE">{{__('Search Engine (Google, Yahoo, Bing...)')}}</option>
                                        ...
                                        <option
                                            value="FRIEND">{{__('From a friend, family member, or coworker')}}</option>
                                    </select>
                                </div>
                            </div>
                      ...
                      <i class="fa fa-plus"></i>
                        ...
                        <i class="fa fa-plus"></i>
                                    ...
                                    <small
                                        class="text-muted text-danger text-center d-block mb-3">{{ __('(required)') }}</small>
                                </div>
                                <div class="col-6 col-sm-3">
                                    <input type="file" name="right_side" id="rightSideInput"
                                           data-text="{{__('Right View')}}"
                                           class="visually-hidden" accept="image/*" required>
                        ...
                        <i class="fa fa-plus"></i>
                                ...
                                <div class="col-6 col-sm-3">
                                    <input type="file" name="right_closed" id="rightClosedSideInput"
                                           data-text="{{__('Right View Closed')}}" class="visually-hidden"
                        ...
                        <i class="fa fa-plus"></i>
                                ...
                                <div class="col-6 col-sm-3">
                                    <input type="file" name="front_closed" id="frontClosedInput"
                                           data-text="{{__('Front View Closed')}}"
                                           class="visually-hidden" accept="image/*" required>
                      ...
                      <i class="fa fa-plus"></i>
                        ...
                        <i class="fa fa-plus"></i>
                            ...
                            <button type="submit"
                                    class="btn btn-primary rounded-5 mx-auto d-block">{{__('Apply')}}</button>
                        </form>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-body">
                    ...
                    <div id="picture-controls" class="d-none justify-content-center">
                        <button id="retake-picture" class="btn btn-danger d-block"><i
                                class="fa fa-repeat me-1"></i>{{__('Retake')}}
                        </button>
                        <button id="use-picture" class="btn btn-info d-block ms-2"><i
                                class="fa fa-check me-1"></i>{{__('Use')}}
                        </button>
                    </div>
...
{{--                closeOnSelect: false--}}
{{--            });--}}
{{--            $('.selectHeight').select2();--}}
{{--            $('.selectWeight').select2();--}}

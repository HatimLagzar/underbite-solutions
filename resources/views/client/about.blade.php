        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7">
                    ...
                    <div class="row">
                        <p class="col-12">{{__('To the general public, dentistry and dental surgery are mostly associated with fixing teeth. However, dental medicine isn’t only about fixing your teeth but also covers other aspects of craniofacial complex root.')}}</p>
                    ...
                    <div class="d-flex justify-content-center align-items-center">
                        <a href="/#form-wrapper"
                           class="btn btn-light px-5 shadow rounded-5 apply mt-4">{{ __('Apply & Meet Us') }}</a>
                    </div>
                </div>
            </div>
        </div>

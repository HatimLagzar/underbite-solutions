<div class="card advanced-patient-search">
    ...
    <div class="card-body">
        <form action="" class="">
            <div class="col-3 form-group d-inline-block">
                <h6>Age</h6>
                <label class="text-sm">
            ...
            <div class="col-2 form-group d-inline-block">
                <label for="gender" class="form-label">Gender</label>
                <select name="gender" id="gender" class="form-select form-select-sm w-auto">
                    <option value>All</option>
                    <option value="1" {{ request()->get('gender') === '1' ? 'selected' : '' }}>Male</option>
                    <option value="2" {{ request()->get('gender') === '2' ? 'selected' : '' }}>Female</option>
                </select>
            </div>
            <div class="col-2 form-group d-inline-block mt-4">
            ...
            <div class="col-2 form-group d-inline-block mt-4">
                ...
                <select name="continent" id="continent" class="form-select form-select-sm">
                    <option value>All</option>
            ...
            <div class="col-3 form-group d-inline-block mt-4">

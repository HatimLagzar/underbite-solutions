...
function buildDropDown(selectElement) {
    selectElement.insertAdjacentHTML(
      ...
      <button type="button" class="form-select form-select-sm w-auto" style="width: 100px !important" >Open</button>
    ...
    selectElement.nextElementSibling.querySelectorAll("ul li").forEach((liElem) => {
        liElem.addEventListener("click", (e) => {
            ...
            if (selectedChoices.length > 0) {
                ...
                $('button.form-select.border-success').text('selected');
            } else {
                selectElement.nextElementSibling
                    .querySelector('button.form-select')
                    .style
                ...
                selectElement.nextElementSibling
                    .querySelector('button.form-select').textContent = 'open';
                selectElement.nextElementSibling
                    .querySelector('button.form-select')
                    .classList
